...
public abstract class JAnimation<T> extends JPanel {
    //Using data structures which mimic (and internally use in the case of ArrayList<T>) resizable arrays for each component's animation-specific listener and all active animations
